...
class Hongbao extends BaseComponent {
  constructor() {
    ...
    this.getExpireHongbao = this.getExpireHongbao.bind(this)
  }
  ...
  async getExpireHongbao(req, res, next) {
    this.hongbaoHandle(req, res, 'expired')
  }

  async hongbaoHandel(req, res, type) {
